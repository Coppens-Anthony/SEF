...
<main>
    <section class="donateForm">
        ...
        <article class="rising">
            ...
            <form action="" method="post">
                ...
                <div class="otherRise_container">
                    <input type="number" id="otherRise" name="otherRise" placeholder="Choisissez votre propre montant" required>
                    <label for="otherRise" class="sr-only">Autre montant</label>
                </div>
            </form>
        </article>
        <article class="coords">
        ...
        <form action="" method="post" class="moneyButton">
