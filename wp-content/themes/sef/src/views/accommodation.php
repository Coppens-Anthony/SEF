...
<body>
<h1 class="sr-only">Nos h&eacute;bergements</h1>
<header>
    <nav id="mainNav">
        <a href="/">
        ...
        <nav id="burgerNav">
            ...
            <ul>
                ...
                <li>
                    <a href="accommodation.php" class="main" title="Vers la page des h&eacute;bergements">H&eacute;bergements</a>
                </li>
                <li class="navContact">
...
<main>
    <section class="intro">
        ...
        <p>L&apos;insertion ou la r&eacute;insertion sociale d&apos;adultes et de familles en difficult&eacute;
            Le temps pass&eacute; au SEF doit être mis &agrave; profit par chacun pour r&eacute;gler ses questions administratives,
            repenser sa fa&ccedil;on de vivre avec les autres et pr&eacute;parer son d&eacute;part. Afin, si possible, de ne pas revenir.</p>
        <img alt="Image repr&eacute;sentant les projets" src="../img/accommodation.jpg" height="500" width="1000"/>
    </section>
    <section class="sections" id="houses">
        ...
        <article>
            ...
            <p>
                <i>Cette maison se situe Rue des Augustins, 27 &agrave; Huy.</i>
                <br>
                <br>
                Elle nous permet d&apos;h&eacute;berger en moyenne <span class="blue">40 personnes</span> par an qui sont dans le besoin.
                Elle dispose de <span class="blue">8 lits</span> en h&eacute;bergement d&apos;urgence ainsi qu&apos;un logement supervis&eacute; (1 &agrave; 2 personnes),
                ce qui permet une autonomie pendant quelque temps dans une structure semi-communautaire.
            </p>
            <img alt="Image du premier h&eacute;bergement" src="../img/houses/firstHouse.jpg" height="427" width="320"/>
        </article>
        <article>
            <h3 class="sr-only">Deuxi&egrave;me h&eacute;bergement</h3>
            <img alt="Image du deuxi&egrave;me h&eacute;bergement" src="../img/houses/secondHouse.jpg" height="600" width="450"/>
            <p class="secondHouse">
                <i>Cette maison se situe Rue du March&eacute; 35 &agrave; Huy.</i>
                <br>
                <br>
                Elle nous permet d&apos;h&eacute;berger en moyenne <span class="blue">40 personnes</span> par an qui sont dans le besoin.
                Elle dispose de <span class="blue">8 lits</span> en h&eacute;bergement d&apos;urgence.
            </p>
        </article>
    </section>
</main>
